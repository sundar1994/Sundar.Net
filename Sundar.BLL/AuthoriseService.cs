...
namespace Sundar.BLL
{
    ...
    public class AuthoriseService : BaseApp<Sys_User>
    {
        ...
        public Sys_User User
        {
            ...
            {
                _user = value;
                _userRoleIds = UnitWork.Find<Relevance>(u => u.FirstId == _user.Id).Select(u => u.SecondId).ToList();
            }
        }
        ...
        public virtual IQueryable<Sys_ModuleElement> GetModuleElementsQuery()
        {
            ...
            return UnitWork.Find<Sys_ModuleElement>(u => u.Id > 0);
        }
        ...
        public virtual IQueryable<Sys_Module> GetModulesQuery()
        {
            ...
            //var moduleIds = UnitWork.Find<Sys_Module>(c => c.Id > 0).ToList();
            return UnitWork.Find<Sys_Module>(u => u.Id > 0).OrderBy(u => u.SortNo);
        }
